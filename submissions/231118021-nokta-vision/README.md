...
## 📱 Expo Bağlantısı & Önizleme

Uygulamayı **Expo Go (expo-go)** üzerinde anında test etmek için aşağıdaki adresi veya QR kodu kullanabilirsiniz:

> [!TIP]
> **Expo Geliştirici QR / Preview Linki:**
> [`exp://172.20.10.2:8081`](exp://172.20.10.2:8081)

**Yerel başlatma adımları:**
```bash
...
## 🎬 Proje Tanıtım & Demo Video Alanı

Uygulamanın kullanımını ve tüm özelliklerini tanıtan 60 saniyelik demo videosuna ve APK dosyasına buradan ulaşabilirsiniz:
